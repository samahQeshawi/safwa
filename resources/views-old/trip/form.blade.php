...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
            <label for="category_id" class="col-md-3 control-label">{{ trans('trip.category_id') }}</label>
            <div class="col-md-9">
                <select class="form-control" id="category_id" name="category_id" required="true">
                        <option value="" style="display: none;" {{ old('category_id', optional($trip)->category_id ?: '') == '' ? 'selected' : '' }} disabled selected>{{ trans('trip.service_id__placeholder') }}</option>
                        @if(!empty($categories))
                        @foreach ($categories as $key => $value)
                            <option value="{{ $key }}" {{ old('category_id', optional($trip)->category_id) == $key ? 'selected' : '' }}>
                                {{ $value }}
                            </option>
                        @endforeach
                        @endif
...
<div class="form-group {{ $errors->has('from_address') ? 'has-error' : '' }}">
    ...
    <div class="col-md-9">
        <input class="form-control" name="from_address" type="text" id="from_address" value="{{ old('from_address', optional($trip)->from_address) }}"  placeholder="{{ trans('trip.from_address__placeholder') }}">
...
<div class="form-group {{ $errors->has('to_address') ? 'has-error' : '' }}">
    ...
    <div class="col-md-9">
        <input class="form-control" name="to_address" type="text" id="to_address" value="{{ old('to_address', optional($trip)->to_address) }}"  placeholder="{{ trans('trip.to_address__placeholder') }}">
...
<div class="form-group {{ $errors->has('distance') ? 'has-error' : '' }}">
    ...
    <div class="col-md-9">
        <input class="form-control" name="distance" type="text" id="distance" value="{{ old('distance', optional($trip)->distance) }}" placeholder="{{ trans('trip.distance__placeholder') }}" readonly>
...
<div class="form-group {{ $errors->has('amount') ? 'has-error' : '' }}">
    ...
    <div class="col-md-9">
        <input class="form-control" name="amount" type="text" id="amount" value="{{ old('amount', optional($trip)->amount) }}" placeholder="{{ trans('trip.amount__placeholder') }}">
...
<div class="form-group {{ $errors->has('minimum_charge') ? 'has-error' : '' }}">
    ...
    <div class="col-md-9">
        <input class="form-control" name="minimum_charge" type="text" id="minimum_charge" value="{{ old('minimum_charge', optional($trip)->minimum_charge) }}" placeholder="{{ trans('trip.minimum_charge__placeholder') }}">
        {!! $errors->first('minimum_charge', '<p class="help-block">:message</p>') !!}
    </div>
</div>
</div>
<div class="col-md-6"><trips :trip="{{ $trip->id }}"></trips>
</div>
</div>
...
<div class="form-group {{ $errors->has('km_charge') ? 'has-error' : '' }}">
    ...
    <div class="col-md-9">
        <input class="form-control" name="km_charge" type="text" id="km_charge" value="{{ old('km_charge', optional($trip)->km_charge) }}" placeholder="{{ trans('trip.km_charge__placeholder') }}" autocomplete="off">
...
<div class="form-group {{ $errors->has('cancellation_charge') ? 'has-error' : '' }}">
    <label for="cancellation_charge" class="col-md-6 control-label">{{ trans('trip.cancellation_charge') }}</label>
    <div class="col-md-9">
        <input class="form-control" name="cancellation_charge" type="text" id="cancellation_charge" value="{{ old('cancellation_charge', optional($trip)->cancellation_charge) }}" placeholder="{{ trans('trip.cancellation__placeholder') }}" autocomplete="off">
...
<div class="form-group {{ $errors->has('pickup_on') ? 'has-error' : '' }}">
    ...
    <div class="col-md-9">
        <input class="form-control date-picker" name="pickup_on" type="text" id="pickup_on" value="{{ old('pickup_on', optional($trip)->pickup_on) }}" placeholder="{{ trans('trip.pickup_on__placeholder') }}" autocomplete="off">
...
<div class="form-group {{ $errors->has('dropoff_on') ? 'has-error' : '' }}">
    ...
    <div class="col-md-9">
        <input class="form-control date-picker" name="dropoff_on" type="text" id="dropoff_on" value="{{ old('dropoff_on', optional($trip)->dropoff_on) }}" placeholder="{{ trans('trip.dropoff_on__placeholder') }}" autocomplete="off">
...
<div class="form-group {{ $errors->has('discount') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="discount" type="text" id="discount" value="{{ old('discount', optional($trip)->discount) }}" placeholder="{{ trans('trip.discount__placeholder') }}">
...
<div class="form-group {{ $errors->has('tax') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="tax" type="text" id="tax" value="{{ old('tax', optional($trip)->tax) }}"  placeholder="{{ trans('trip.tax__placeholder') }}">
...
<div class="form-group {{ $errors->has('final_amount') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="final_amount" type="text" id="final_amount" value="{{ old('tax', optional($trip)->final_amount) }}"  placeholder="{{ trans('trip.final_amount__placeholder') }}">
    ...
    <div class="col-md-9">
        <select class="form-control" id="payment_method" name="payment_method" required="true">
                ...
                @foreach ($payment_method as $key => $value)
                    <option value="{{ $key }}" {{ old('payment_method', optional($trip)->payment_method) == $key ? 'selected' : '' }}>
                        {{ $value }}
                    </option>
                @endforeach
        </select>
...
<div class="form-group {{ $errors->has('is_now_trip') ? 'has-error' : '' }}">
    <label for="is_now_trip" class="col-md-6 control-label">{{ trans('trip.is_now_trip') }}</label>
    <div class="col-md-10">
        <div class="checkbox">
            <label for="payment_status">
                <input id="payment_status" class="" name="is_now_trip" type="checkbox" value="1"
                    {{ old('payment_status', optional($trip)->is_now_trip) == '1' ? 'checked' : '' }}>
                {{ trans('trip.is_now_trip_status') }}
            </label>
        </div>
