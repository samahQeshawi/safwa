            ...
            <div class="row">
                <div class="col-md-12">
                    <form method="POST" id="search-form" class="form-inline" role="form">
                        ...
                        <div class="form-group ">
                            <label for="phone" class="mb-2 mr-sm-2">{{ trans('coupon_reports.coupon_code_filter') }}</label>
                            <select class="form-control  mb-2 mr-sm-2" id="coupon_code_filter" name="coupon_code_filter" required="true">
                                <option value="0">
                                    {{ trans('coupon_reports.coupon_code_filter__placeholder') }}</option>
...
<script>
    $(document).ready(function() {
            var table = $('#dataList').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('coupon_reports.index') }}",
                    data: function (d) {
