...
return [
    ...
    'company_id' => 'Company',
    'company_id__placeholder' => 'Select company',
    'is_active' => 'Is Active',
    'is_active_0' => 'Inactive',
    'is_active_1' => 'Active',
    ...
    'index_route_description' => 'Retrieve existing stores.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the store property name where the value is the assigned value to the retrieved store.',
    ...
    'show_route_description' => 'Retrieve existsing store.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the store to retrieve',
    'destroy_route_description' => 'Delete existsing store.',
    ...
    'the_id_of_model_to_delete' => 'The id of the store to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete stores.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the store.',
    ...
    'the_requested_model_does_not_exists' => 'The requested store does not exists.',
    ...
    'edit' => 'Edit Store',
    'show' => 'Show Store',
    'show_all' => 'Show All Store',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Store.',
    'none_available' => 'No Stores Available.',
    'model_plural' => 'Stores',
    'model_was_added' => 'Store was successfully added.',
    'model_was_retrieved' => 'Store was successfully retrieved.',
    'models_were_retrieved' => 'Stores were successfully retrieved.',
    'model_was_updated' => 'Store was successfully updated.',
    'model_was_deleted' => 'Store was successfully deleted.',
