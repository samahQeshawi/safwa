...
return [
    ...
    'index_route_description' => 'Retrieve existing groups.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the group property name where the value is the assigned value to the retrieved group.',
    ...
    'show_route_description' => 'Retrieve existsing group.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the group to retrieve',
    'destroy_route_description' => 'Delete existsing group.',
    ...
    'the_id_of_model_to_delete' => 'The id of the group to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete groups.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the group.',
    ...
    'the_requested_model_does_not_exists' => 'The requested group does not exists.',
    ...
    'edit' => 'Edit Group',
    'show' => 'Show Group',
    'show_all' => 'Show All Group',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Group.',
    'none_available' => 'No Groups Available.',
    'model_plural' => 'Groups',
    'model_was_added' => 'Group was successfully added.',
    'model_was_retrieved' => 'Group was successfully retrieved.',
    'models_were_retrieved' => 'Groups were successfully retrieved.',
    'model_was_updated' => 'Group was successfully updated.',
    'model_was_deleted' => 'Group was successfully deleted.',
