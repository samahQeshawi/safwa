...
<h1 class="m-0 text-dark">{{ trans('favorite_places.create') }}</h1>
    ...
    <div class="card card-primary card-outline">
        <div class="card-body">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="{{ route('favorite_places.store') }}" accept-charset="UTF-8"
                    id="create_favorite_place_form" name="create_favorite_place_form" class="form-horizontal">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <input class="btn btn-primary" type="submit" value="{{ trans('favorite_places.add') }}">
                        </div>
                    </div>
