...
<div class="row">
    <div class="col-md-6">
        ...
        <input class="form-control" name="latitude" type="hidden" id="latitude" value="{{ old('latitude', optional($company)->latitude) }}">
        <input class="form-control" name="longitude" type="hidden" id="longitude" value="{{ old('longitude', optional($company)->longitude) }}">       
    </div>
    <div class="col-md-6">
