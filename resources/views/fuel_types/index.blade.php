...
@section('content_header')
    <h1 class="m-0 text-dark">{{ trans('fuel_types.model_plural') }}</h1>
        ...
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table id="dataList" class="display table table-striped">
                    <thead>
                        <tr>
                            <th>{{ trans('fuel_types.slno') }}</th>
                            <th>{{ trans('fuel_types.fuel_type') }}</th>
                            <th></th>
                        </tr>
                    </thead>
                </table>
...
<script>
    $(document).ready(function() {
            var table = $('#dataList').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('fuel_types.fuel_type.index') }}",
                columns: [
