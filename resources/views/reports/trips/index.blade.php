...
@section('js')
<script> 
     var statusMap = {"1":"New","2":"Pending","3":"No Driver Avaliable","4":"Driver Accepted","5":"Driver Reached Pickup Location",
			"6":"Trip Started","7": "Reached Destination","8": "Completed","9":"Money Collected","10":"Trip Cancelled by driver",
    ...
    $(document).ready(function() {
		    ...
		    { data: null,
       		      render: function ( data, type, row ) {
                            if(statusMap[data.status]) return statusMap[data.status];
                     }
                    },
		     { data: null,
		 	render: function ( data, type, row ) {
