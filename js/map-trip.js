...
var mapOptions, map, marker1, marker2, searchBox,directionsService,directionsDisplay,
	infoWindow = '',
	start_address = document.querySelector( '#from_address' ),
	start_lat = document.querySelector( '.trip_pickup_latitude' ),
	start_long = document.querySelector( '.trip_pickup_longitude' ),
	start_location = document.querySelector( '.from_location' ),
	end_address = document.querySelector( '#to_address' ),
	end_lat = document.querySelector( '.trip_drop_latitude' ),
	end_long = document.querySelector( '.trip_drop_longitude' ),
	end_location = document.querySelector( '.to_location' ),
...
function calculate_route(){
	...
	directionsService.route(request, function (result, status) {
		if (status == google.maps.DirectionsStatus.OK) {
			distance_field.value = result.routes[0].legs[0].distance.value;
			...
			google.maps.event.addListener(directionsDisplay, 'directions_changed', function() {
				...
				distance_field.value = (distance_meter / 1000);
				...
				start_location.value = directions.routes[0].legs[0].start_location.lat() + ',' + directions.routes[0].legs[0].start_location.lng();
				end_lat.value = directions.routes[0].legs[0].end_location.lat();
				end_long.value = directions.routes[0].legs[0].end_location.lng();
				end_location.value = directions.routes[0].legs[0].end_location.lat() + ',' + directions.routes[0].legs[0].end_location.lng();
			});
		} else {
