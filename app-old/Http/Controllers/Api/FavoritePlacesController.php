...
class FavoritePlacesController extends Controller
{
    ...
    public function directions(Request $request)
    {
        ...
        if ($direction_data) {
            ...
            $direction_url = "https://maps.googleapis.com/maps/api/directions/json?origin=" . $directions['from_lat'] . "," . $directions['from_long'] . "&destination=" . $directions['to_lat'] . "," . $directions['to_long'] . "&key=AIzaSyDpuXp5i5ud7H3YqQQVVnAoD8dbBJ24Pe8";
