...
Route::group(['middleware'=> ['WebLang']] , function() {
    ...
    Route::get('/', function() {
        if( empty( session()->get('lang') ) ) session()->put('lang', 'en');
        return redirect('/' . session()->get('lang') . '/home');
    });
    Route::namespace('Web')->group(function (){
        Route::get('/pick_location', 'IndexController@getLocation')->name('pick_location');
    });

    Route::namespace('Web')->prefix('{lang}')->name('web.')->middleware('lang')->group(function() {
        ...
        Route::get('/customers_portal', 'PagesController@login');
        ...
        // Route::get('/images', 'PagesController@showImages');
        // Route::get('/videos', 'PagesController@showImages');
        // // Route::get('/videos', 'PagesController@showVideos');
        // Route::get('/blog', 'PagesController@showBlog');
        // Route::get('/faqs', 'PagesController@showFaqs');
...
Route::group([
    'middleware' => ['permission:view coupon'],
    'prefix' => 'coupons',
], function () {
...
Route::group([
    ...
    Route::get('/show/{paymentmethod}', 'PaymentMethodsController@show')
        ->name('paymentmethod.show')->where('id', '[0-9]+');
    Route::get('/{paymentmethod}/edit', 'PaymentMethodsController@edit')
        ->name('paymentmethod.edit')->where('id', '[0-9]+');
    ...
    Route::put('paymentmethod/{paymentmethod}', 'PaymentMethodsController@update')
        ->name('paymentmethod.update')->where('id', '[0-9]+');
    Route::delete('/paymentmethod/{paymentmethod}', 'PaymentMethodsController@destroy')
        ->name('paymentmethod.destroy')->where('id', '[0-9]+');
});
Route::group([
    'prefix' => 'carmakes',
], function () {
...
Route::group([
    ...
    Route::get('/nearest-drivers/{customer}', 'CustomersController@getNearestDrivers')
        ->name('customers.customer.nearest');
    Route::get('/show/{customer}', 'CustomersController@show')
        ->name('customer.show')->where('id', '[0-9]+');
    ...
    Route::delete('/customer/{customer}', 'CustomersController@destroy')
        ->name('customer.destroy')->where('id', '[0-9]+');
...
Route::group([
    ...
    Route::get('/category_type/{type}', 'CategoriesController@view_category')
        ->name('categories.category.view_categories');
});
...
Route::group([
    ...
    Route::get('/', 'RealTimeController@realMap')
...
Route::get('/privacy_policy', 'PagesController@privacyPolicy')
    ->name('pages.page.privacy_policy');
Route::get('/terms_conditions', 'PagesController@termsConditions')
    ->name('pages.page.terms_conditions');
