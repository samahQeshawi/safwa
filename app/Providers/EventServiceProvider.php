...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        \App\Events\AutoPaymentCompleteEvent::class => [
            \App\Listeners\SendPaymentCollectNotiicationListener::class,
        ],
        \App\Events\PaymentStatusPaidEvent::class => [
            \App\Listeners\SendPaymentStatusCollectNotiicationListener::class,
        ],
    ];
