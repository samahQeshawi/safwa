...
class PaymentController extends CustomersTripsController
{
    ...
    public static function checkout(Request $request, $createRegistration = false)
    {
        ...
        if( $createRegistration ) {
            ...
            $data .= "&merchantTransactionId=" . md5(time()) /* $request->id_no */ .
         //   "&testMode=EXTERNAL" .
            ...
            "&customer.street1=riyadh" .
            "&customer.city=riyadh" .
            "&customer.state=riyadh" .
            "&customer.country=SA" .
            "&customer.postcode=123456" .
            ...
            "&customer.givenName=alyaa" .
            "&customer.surname=darweesh";
